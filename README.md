...
![скрин](https://github.com/AleksanderB5/sys-pattern-homework-8-2/blob/Индексы/фото/Снимок%20экрана%202024-09-09%20230028.png)

Сравним, к примеру время запроса в первом варианте было около 5 секунд, во втором около 0,026 секунды. 
